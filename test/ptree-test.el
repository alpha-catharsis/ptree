...
(ert-deftest ptree-test-add-branch-nodes ()
  (let ((pt (list nil nil nil)))
    (ptree-add-branch-nodes pt)
    (should (equal pt '(nil nil nil)))
    (ptree-add-branch-nodes pt "zero" 0 'zero)
    (should (equal pt '(nil nil (0 nil nil) (zero nil nil) ("zero" nil nil))))
    (ptree-add-branch-nodes pt 'zero 0 "zero")
    (should (equal pt '(nil nil (0 nil nil) (zero nil nil) ("zero" nil nil)))))
  (let ((pt (list nil nil nil)))
    (ptree-add-branch-nodes pt 0 0 0 0 0 0 0 0)
    (should (equal pt '(nil nil (0 nil nil)))))
  (let ((pt (list nil nil (list 0 nil (list 1 nil nil)))))
    (ptree-add-branch-nodes pt 0)
    (should (equal pt '(nil nil (0 nil (1 nil nil)))))))

(ert-deftest ptree-test-add-branch-at-path ()
  (let ((pt (list nil nil nil)))
    (ptree-add-branch-at-path pt 0)
    (ptree-add-branch-at-path pt '(zero))
    (ptree-add-branch-at-path pt "one")
    (should (equal pt '(nil nil (0 nil nil) (zero nil nil) ("one" nil nil)))))
  (let ((pt (list nil nil nil)))
    (ptree-add-branch-at-path pt '(0 1 2))
    (ptree-add-branch-at-path pt '(0 zero "one"))
    (ptree-add-branch-at-path pt '("one" zero 0))
    (should (equal pt '(nil nil (0 nil (1 nil (2 nil nil))
                                   (zero nil ("one" nil nil)))
                            ("one" nil (zero nil (0 nil nil)))))))
  (let ((pt (list nil (list "test" 42))))
    (ptree-add-branch-at-path pt '("test" 0))
    (should (equal pt '(nil nil ("test" nil (0 nil nil))))))
  (let ((pt (list nil nil nil)))
    (ptree-add-branch-at-path pt '(0 1 2 3))
...
(ert-deftest ptree-test-iter-add-branch-nodes ()
  (let* ((branch-1 (list "test" nil (list 'zero 42)))
         (root (list nil nil branch-1))
         (iter (list branch-1 root)))
    (ptree-iter-add-branch-nodes iter)
    (should (eq (car iter) branch-1))
    (should (eq (cadr iter) root))
    (ptree-iter-add-branch-nodes iter 'abc "b" "c")
    (should (equal (car iter) '("test" nil (abc nil nil) (zero 42)
                                ("b" nil nil) ("c" nil nil))))
    (should (equal (cadr iter) '(nil nil ("test" nil (abc nil nil) (zero 42)
                                ("b" nil nil) ("c" nil nil)))))
    (ptree-iter-add-branch-nodes iter 'abc)
    (should (equal (car iter) '("test" nil (abc nil nil) (zero 42)
                                ("b" nil nil) ("c" nil nil))))
    (should (equal (cadr iter) '(nil nil ("test" nil (abc nil nil) (zero 42)
                                ("b" nil nil) ("c" nil nil)))))))

(ert-deftest ptree-test-iter-add-leaf ()
  (let* ((child-1 (list "test" nil (list 'zero 42)))
         (root (list nil nil child-1))
         (iter (list child-1 root)))
    (ptree-iter-add-leaf iter 0 "x")
    (should (equal (car iter) '("test" nil (0 "x") (zero 42))))
    (should (equal (cadr iter) '(nil nil ("test" nil (0 "x") (zero 42)))))
    (ptree-iter-add-leaf iter "a" 9)
    (should (equal (car iter) '("test" nil (0 "x") (zero 42) ("a" 9))))
    (should (equal (cadr iter) '(nil nil ("test" nil (0 "x") (zero 42)
                                          ("a" 9)))))
    (ptree-iter-add-leaf iter 'zero 100)
